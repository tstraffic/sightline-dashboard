...
const CATEGORIES = [
  ...
  { key: 'safety_docs',        label: 'Safety documents & tickets', desc: 'SWMS, SOPs, risk assessments, inductions & ticket expiry',      types: ['swms_expiring', 'sop_expiring', 'risk_assessment_expiring', 'ticket_expiry', 'cert_expiry', 'induction_reminder', 'induction_overdue'], inApp: true, email: true },
