...
const CATEGORIES = [
  ...
  { key: 'compliance',         label: 'Compliance & plan expiry', desc: 'SWMS, SOPs, risk assessments, tickets, ROL & permits expiring',   types: ['expiring_compliance', 'swms_expiring', 'sop_expiring', 'risk_assessment_expiring', 'ticket_expiry', 'rol_pending', 'induction_reminder', 'induction_overdue', 'cert_expiry'], inApp: true, email: true },
