...
const SECTIONS = [
  { key: 'operations', label: 'Operations', hubHref: '/departments/operations', hubActive: 'dept-operations', links: [
  ...
  { key: 'planning', label: 'Planning', hubHref: '/departments/planning', hubActive: 'dept-planning', links: [
  ...
  { key: 'safety', label: 'Safety', hubHref: '/departments/safety', hubActive: 'dept-safety', links: [
  ...
  { key: 'people', label: 'People', hubHref: '/departments/people', hubActive: 'dept-people', links: [
  ...
  { key: 'finance', label: 'Money', hubHref: '/departments/finance', hubActive: 'dept-finance', links: [
  ...
  { key: 'sales', label: 'Clients & Sales', links: [
  ...
  { key: 'assets', label: 'Assets', hubHref: '/departments/assets', hubActive: 'dept-assets', links: [
  ...
  { key: 'reports', label: 'Reports', hubHref: '/departments/reports', hubActive: 'dept-reports', links: [
  ...
  { key: 'admin', label: 'Admin', links: [
    ...
    { label: "IT Feedback", href: "/feedback",
      ...
      active: ["feedback"],
      show: (ctx) => ctx.can('admin') || ctx.user.role === 'admin' },
  ] },
];
